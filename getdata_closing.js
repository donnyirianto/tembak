...
const doitBro = async () => {
    try {    
      ...
      //(select sum(saldo_akh) from ${r.kdtk}2301) as saldo_akh,
         ...
         (select COUNT(*) from information_schema.tables where table_name='${r.kdtk}2302') as ada_table,
         (select TABLE_ROWS from information_schema.tables where table_name='${r.kdtk}2302') as total_rows_filet,
