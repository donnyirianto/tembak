    ...
    try{  
      ...
      fileReport.once('open', async function(fd) { 
        ...
        results.forEach( async (r) => { 
          ...
          const queryTembak = `SELECT  '${r.kdcab}' as kdcab, '${r.kdtk}' as kdtk, '${r.nama}' as nama_toko,
          (select count(*) from prodmast where ket like '%13071%' AND CTGR='XX') as pfe_update,
          (select count(*) from prodmast where ket not like '%13071%' AND CTGR='XX') pfe_tidk_update,
